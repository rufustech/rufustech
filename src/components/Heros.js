    ...
    <div>
      <div className="lg relative">
        <img
          ...
          className="w-full rounded-md shadow-xl dark:shadow-black/20"
          src={background}
          alt="image"
        />
        <div className="absolute inset-0 flex justify-center items-center text-center">
          ...
          >
            <h4 className="mt-2 mb-8 text-2xl font-bold tracking-tight md:text-3xl xl:text-3xl text-white">
              <span className='text-white animate-bounce'>Hello, My name is</span> <br /> Rufaro Mucheri <br /><span className="text-primary text-white">I am a Web Developer</span>
            </h4>
            <a href='/contact'>
              <button
                type="button"
