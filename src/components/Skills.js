...
function Skills() {
  ...
  <div class="container mb-20 lg:mt-60 xl:pt-2  lg:mt-16  mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font pb-4 text-gray-900">Professional Skills</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">My Skills</p>
    </div>
    <div class="flex flex-wrap -m-4">
      ...
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">React</h2>
          <p class="leading-relaxed text-base">Proficient in React framework, specializing in building modern and responsive user interfaces for web applications. Skilled in state management with Redux and integrating React with backend technologies.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          <div class="w-10 h-10 inline-flex items-center justify-center rounded-full bg-purple-100 text-purple-500 mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 326" id="django"><g fill="#2BA977"><path d="M114.784 0h53.278v244.191c-27.29 5.162-47.38 7.193-69.117 7.193C33.873 251.316 0 222.245 0 166.412c0-53.795 35.93-88.708 91.608-88.708 8.64 0 15.222.68 23.176 2.717V0zm1.867 124.427c-6.24-2.038-11.382-2.717-17.965-2.717-26.947 0-42.512 16.437-42.512 45.243 0 28.046 14.88 43.532 42.17 43.532 5.896 0 10.696-.332 18.307-1.351v-84.707z"></path><path d="M255.187 84.26v122.263c0 42.105-3.154 62.353-12.411 79.81-8.64 16.783-20.022 27.366-43.541 39.055l-49.438-23.297c23.519-10.93 34.901-20.588 42.17-35.327 7.61-15.072 10.01-32.529 10.01-78.445V84.261h53.21zM196.608 0h53.278v54.135h-53.278V0z"></path></g></svg>
          </div>
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">Django</h2>
          <p class="leading-relaxed text-base"> Proficient in Django framework, capable of developing robust web applications with clean and maintainable code. Experienced in building RESTful APIs and integrating Django with frontend frameworks like React.</p>
        </div>
      </div>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <div class="border border-gray-200 p-6 rounded-lg">
          ...
          <h2 class="text-lg text-gray-900 font-medium title-font mb-2">DevOps</h2>
          <p class="leading-relaxed text-base">Experienced in DevOps practices, specializing in automating deployment pipelines to streamline the release process. Proficient in configuring CI/CD pipelines using tools like Jenkins and GitLab CI.</p>
        </div>
      </div>
    </div>
