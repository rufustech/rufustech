...
function Skills() {
  ...
  <div class="container mb-20 xl:pt-16 px-5 xl:mt-96 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Professional Skills</h1>
